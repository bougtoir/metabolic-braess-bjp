"""Cenozoic step 4: sampling-bias sensitivity — strict replication of
dinosaur analysis/06_sampling_bias.py (identical five corrections).
"""
...
def main() -> None:
    ...
    write_table(out, "sampling_sensitivity.csv")
