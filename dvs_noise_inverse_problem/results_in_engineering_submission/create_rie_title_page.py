#!/usr/bin/env python3
"""
Generate title page for Results in Engineering submission.

Results in Engineering uses a single-anonymised review process.
Author information is included on a separate title page.
"""
...
def build_title_page():
    ...
    info_items = [
        ...
        'Target journal: Results in Engineering (ISSN 2590-1230)',
        'Number of figures: 8',
    ...
    out_path = OUT_DIR / 'title_page_rie.docx'
