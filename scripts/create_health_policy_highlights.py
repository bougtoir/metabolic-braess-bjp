#!/usr/bin/env python3
"""Create Highlights / Key Points file for Health Policy submission.

Health Policy requires 3-5 Highlights as a separate file;
...
out = os.path.join(OUTPUT_DIR, 'highlights_Health_Policy_EN.docx')
doc.save(out)
print(f"Saved: {out}")
