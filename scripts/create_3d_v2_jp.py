#!/usr/bin/env python3
"""
Generate 3D extruded polygon maps v2 - JAPANESE labels.
...
configs = [
    {
        ...
        'height_col': 'n_anes',
        'title': '全身麻酔+区域麻酔併用/全身麻酔 比率（色）× 麻酔科医数（高さ）',
        'color_scale': 'PiYG', 'color_vmin': 0, 'color_vmax': 3,
        'height_scale': 0.01,
        'color_label': 'L003/L008 比率',
        'height_label': '麻酔科医数',
    },
    {
        'name': 'L008_by_anes',
    ...
    },
    {
        ...
        'title': '全身麻酔+区域麻酔併用/全身麻酔 比率（色）× 手術あたりGA率（高さ）',
        'color_scale': 'PiYG', 'color_vmin': 0, 'color_vmax': 3,
        'height_scale': 3.0,
        'color_label': 'L003/L008 比率',
        'height_label': 'L008/手術件数',
    },
]

for i, cfg in enumerate(configs, 1):
    print(f"\n[{i}/{len(configs)}] Generating {cfg['name']} (JP)...")
    make_3d_map_v2(
        gdf, gdf_nt,
        cfg['color_col'], cfg['height_col'],
        cfg['title'],
        f"/home/ubuntu/3d_extruded/3D_{cfg['name']}_v2_jp.html",
