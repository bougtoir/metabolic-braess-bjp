#!/usr/bin/env python3
"""Create BMJ Quality & Safety formatted English manuscript.

Conforms to BMJ Quality & Safety original research author
guidelines:
- Title must indicate study design
- Structured abstract (Objectives/Design/Setting/Participants/Main outcome measures/Results/Conclusions) <=300 words
- Key messages (What is already known / What this study adds / How this study might affect...) <=5 sentences
- Body 3000-4000 words; up to 5 tables/figures combined
- Triple-anonymised peer review (separate title page)
...
# BMJ Quality & Safety operates triple-anonymised peer review.
# Author names, affiliations and contact details are supplied on the separate
# title-page file.
add_para("[This is the anonymised manuscript file for triple-anonymised peer "
         "review. Author names, affiliations and contact details are provided "
...
add_para("Target journal: BMJ Quality & Safety", italic=True)
...
add_para(
    "Objectives  To quantify regional variation in anaesthesia practice across "
    "Japanese secondary medical areas and to test whether the variation is "
    "primarily explained by structural access to university hospitals or by "
    "prefecture-specific claims auditing.")

add_para(
    "Design  Cross-sectional ecological study using publicly available "
    "age- and sex-standardised claim ratios.")

add_para(
    "Setting  ${n_areas} secondary medical areas nested within ${n_prefectures} "
    "prefectures of Japan, fiscal year ${fiscal_year}.")

add_para(
    "Participants  Secondary medical areas (the ecological unit of analysis); "
    "individual patient data were not used.")

add_para(
    "Main outcome measures  Standardised claim ratios for general anaesthesia "
    "(L008), spinal anaesthesia (L004), epidural anaesthesia (L002) and "
    "continuous epidural infusion (L003).")
...
add_para(
    ...
    "explained ${L008_ml_r2} of total variance (β = ${L008_ml_coef}, 95% CI "
    "${L008_ml_ci_low} to ${L008_ml_ci_high}, P ${L008_ml_p}) and was positive "
    "in every prefecture. Sensitivity analyses showed that the maximum "
    "audit-related ratio shift was less than ${audit_L008_iqr_pct}% of the "
    "interquartile range for general anaesthesia. Covariate adjustment for "
    "population density and anaesthesiologist supply attenuated but did not "
    "eliminate the university hospital effect.")

add_para(
    "Conclusions  Regional variation in anaesthesia practice is predominantly "
    "structural. It signals a quality and equity gap in access to neuraxial "
    "techniques under universal coverage and should not be interpreted as "
    "evidence of differential auditing.")
...
add_para(
    "Regional variation in medical practice is well documented in high-income "
    "countries, but it is often difficult to distinguish genuine clinical "
    "variation from artefacts of coding, auditing or payment policy. Japan's "
    "uniform national fee schedule combined with prefecture-specific claims "
    "auditing offers a natural experiment for testing these explanations.")
...
add_para(
    ...
    "areas, university hospital presence was the dominant structural determinant "
    "of general, epidural and continuous epidural anaesthesia use, while "
    "differential prefectural auditing could explain only a small fraction of "
    "the observed variation.")

add_para(
    "How this study might affect research, practice or policy")
add_para(
    "Quality and safety improvement efforts should treat geographic variation "
    "in neuraxial and combined general-epidural anaesthesia as a modifiable "
    "equity problem under universal coverage, directing workforce and "
    "monitoring resources toward structural access rather than coding audits.")
...
add_para(
    "Japan's universal health insurance system covers the entire population "
    "under a nationally uniform fee schedule that specifies reimbursement for "
    "every procedure.{1} Because the fee schedule and the insured benefit are "
    "identical across the country, geographic variation in procedure use is "
    "usually interpreted as a signal of differences in clinical supply, "
    "practice style or unmet need. The same data, however, are also used for "
    "prefecture-level insurance auditing (shinsa), and audit intensity varies "
    "across prefectures.{6} This creates two competing explanations for any "
    "observed regional variation: it may reflect genuine differences in the "
    "quality and availability of care, or it may be an artefact of "
    "differential claims scrutiny. Distinguishing these explanations is central "
    "to patient safety, health equity and the efficient governance of "
    "universal coverage systems.")

add_para(
    "Anaesthesia practice is a particularly useful quality-of-care signal. "
    "The choice between general anaesthesia alone and a combined general-"
    "regional technique is clinically consequential: epidural and continuous "
    "epidural techniques may improve pain control and recovery, and emerging "
    "evidence links regional anaesthesia to oncological and functional outcomes "
    "in selected surgeries.{7-9} If access to these techniques varies "
    "systematically by geography, then patients' probability of receiving "
    "potentially beneficial care depends on where they live, which is a "
    "quality and equity problem under universal coverage. Japan's 2026 fee "
    "schedule revision clarified the general-anaesthesia billing code, reducing "
    "one source of audit ambiguity.{10}")

add_para(
    "We used publicly available standardised claim ratios to address: (i) How "
    "large is regional variation in anaesthesia practice? (ii) Is this "
    "variation explained by differential prefectural auditing? (iii) What "
    "proportion of variance lies between and within prefectures? (iv) Which "
    "structural factors, including university hospital proximity, are "
...
add_para(
    ...
    "anaesthesia and was positive in every prefecture, while the amount of "
    ...
    "rejecting differential auditing as the main explanation. The implication "
    "for quality and safety is that the observed variation is a marker of "
    "unequal access to potentially beneficial anaesthesia techniques, not a "
    "signal of coding quality or fraud; it should be addressed through "
    "workforce and monitoring policies rather than additional coding audits.")
...
add_para(
    "Our findings extend beyond Japan in three respects. First, the "
    ...
    "quality and equity agenda: where emerging evidence links regional anaesthesia to "
    ...
    "rich care.{27,28} Extrapolation to low- and middle-income countries "
    "is more cautious because fee schedules and audit arrangements are typically "
    "heterogeneous and claims data often incomplete.")

add_subheading("Implications for quality improvement, practice and policy")
add_para(
    "The findings have three implications for improving quality and safety. "
    "First, variation in neuraxial and combined general-epidural anaesthesia "
    "should be monitored as a system-level quality and equity indicator. In "
    "high-income countries with universal coverage, patients' access to "
    "techniques that may improve recovery should not depend on the local "
    "presence of a university hospital. Second, regulators should not interpret "
    "low regional ratios as evidence of poor coding or underclaiming; our "
    "audit-impact estimates suggest that even the largest plausible audit "
    "effect would shift ratios by only a small fraction of the observed range. "
    "Third, the within-prefecture variance-decomposition framework provides a "
    "transferable quality-surveillance tool for distinguishing administrative "
    "from structural sources of small-area variation in other procedures and "
    "settings.")
# ============================================================
# CONCLUSIONS
# ============================================================
...
add_para(
    ...
    "predominantly structural, driven by access to university hospitals rather "
    "than by insurance auditing. The variation in epidural and continuous "
    "epidural use represents a quality and equity gap under universal coverage. "
    "Quality improvement and patient-safety policy should address supply and "
    "organisational determinants of anaesthesia practice, monitor "
    "technique distribution as a system-level quality indicator, and extend the "
    "same administrative-versus-structural variance decomposition to other "
    "perioperative quality indicators, rather than treat the observed variation "
    "as an artefact of claims processing or auditing.")
# ============================================================
# REFERENCES
# ============================================================
...
# Save
# ============================================================
out = os.path.join(OUTPUT_DIR, 'regional_anaesthesia_BMJ_QS_EN.docx')
doc.save(out)
print(f"Saved: {out}")

# --------------------------------------------------
# Separate title page for BMJ Quality & Safety
# --------------------------------------------------
tp = Document()
...
tp_para("Target journal: BMJ Quality & Safety", italic=True)
...
tp_out = os.path.join(OUTPUT_DIR, 'title_page_BMJ_QS_EN.docx')
tp.save(tp_out)
