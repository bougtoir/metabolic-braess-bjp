#!/usr/bin/env python3
"""Create separate editable tables .docx for BMC Health Services Research submission.
...
out_en = os.path.join(OUTPUT_DIR, 'regional_anaesthesia_tables_BMC_HSR_EN.docx')
doc.save(out_en)
