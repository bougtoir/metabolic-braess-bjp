#!/usr/bin/env python3
"""Create optional Highlights / Key Points file for BMC Health Services Research submission.

BMC Health Services Research does not require Highlights, but a 3-5 bullet
summary can be supplied as supplementary material; each bullet should be no
more than 85 characters.
"""
import json
import os
...
out = os.path.join(OUTPUT_DIR, 'highlights_BMC_HSR_EN.docx')
doc.save(out)
print(f"Saved: {out}")
