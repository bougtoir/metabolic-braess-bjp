#!/usr/bin/env python3
"""Create JECH End-Matter file (uploaded as separate supplementary file).

Contains: Contributorship, Ethics and permissions, Funding, Conflict of
interests, Acknowledgments, Data Availability Statement.
"""
import os
...
add_para("Manuscript: Regional variation in anaesthesia practice under "
         "universal coverage in Japan: a cross-sectional ecological study of "
         "secondary medical areas", italic=True,
...
out = os.path.join(OUTPUT_DIR, 'end_matter_JECH_EN.docx')
doc.save(out)
print(f"Saved: {out}")
