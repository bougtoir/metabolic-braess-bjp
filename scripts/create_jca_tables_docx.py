#!/usr/bin/env python3
"""Create separate editable tables .docx for Journal of Clinical Anesthesia submission.
...
out_en = os.path.join(OUTPUT_DIR, 'regional_anaesthesia_tables_JCA_EN.docx')
doc.save(out_en)
