#!/usr/bin/env python3
"""Create English cover letter for BMC Health Services Research submission."""
import json
import os
...
# Use the word/reference counts generated by create_bmc_hsr_en.py
...
add_para("BMC Health Services Research")
...
add_para(
    ...
    "claims-audit sensitivity\" for possible publication in BMC Health Services Research.")
...
add_para(
    ...
    "policy. We therefore believe the paper is a strong fit for BMC Health Services Research's "
...
add_para(
    ...
    "BMC Health Services Research. The study used publicly available "
    ...
    "for cross-sectional studies, which is uploaded as Supplementary file 1.")
...
add_para(
    "The manuscript is formatted for BMC Health Services Research "
    ...
    "tables, high-resolution figure files, and the STROBE checklist (Supplementary "
    "file 1). A Highlights file is also provided as a separate upload.")
...
out = os.path.join(OUTPUT_DIR, 'cover_letter_BMC_HSR_EN.docx')
doc.save(out)
print(f"Saved: {out}")
