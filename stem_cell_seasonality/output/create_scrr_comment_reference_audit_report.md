...
**Generated:** 2026-08-22T11:10:25Z
**Method:** Articles → Crossref API | Books → Open Library API | URLs → HTTP reachability
**Source:** `scripts/create_scrr_comment.py` REFERENCES list
**Total references:** 5
...
|--------|-------|---------|
| MATCH | 5 | Verified correct (INFO-level notes only) |
...
|---|--------|--------------|------|-------|
| 1 | MATCH | Volpato V | 2018 |  |
| 2 | MATCH | McCreery KP | 2024 |  |
| 3 | MATCH | Bi S | 2020 |  |
| 4 | MATCH | Cai J | 2025 |  |
| 5 | MATCH | Barrett T | 2012 |  |
