#!/usr/bin/env python3
"""Build an editable docx with supplementary tables S1-S4 for Clinical Trials."""
import argparse
import os
...
CAPTIONS = [
    'Supplementary Table S1: Existing approaches to mitigate event dilution in RCTs',
    'Supplementary Table S2: Study-level data for magnesium in AMI',
    'Supplementary Table S3: Study-level data for statins in heart failure',
    'Supplementary Table S4: Bayesian integration results by case and discounting factor (power prior)',
]

# Table indices in the source CCTC documents
# KOTHA_Framework_CCTC.docx table order: 0=Abbreviations, 1=Table 1, 2=Table 2, 3=Table 3, 4=Table 4
# KOTHA_Framework_CCTC_supplementary_tables.docx table order: 0=Supplementary S1 (magnesium), 1=Supplementary S2 (statins)
TABLE_SOURCES = [
...
def build(src_docx=None, supp_docx=None, out_docx='KOTHA_Framework_ClinicalTrials_supplementary_tables.docx'):
