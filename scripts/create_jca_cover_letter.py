...
# Use the word/reference counts generated by create_jca_en.py
...
FLAT.update({
    ...
    'n_tables': str(int(META.get('n_tables', 3))),
...
add_para(
    ...
    "Research Paper (main text approximately ${body_word_count} words; structured "
    "abstract ${abstract_word_count} words, within 300 words; ${n_tables} tables and "
